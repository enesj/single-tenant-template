(ns app.admin.frontend.adapters.expenses.ui-state
  (:require
...
(rf/reg-event-db
  :app.admin.frontend.adapters.expenses/initialize-entity
  (fn [db [_ entity-key opts]]
    (initialize-entity-ui-state db entity-key opts)))

(defn init-expenses-adapter!
  []
  (rf/dispatch [:app.admin.frontend.adapters.expenses/initialize-entity
                :expenses
