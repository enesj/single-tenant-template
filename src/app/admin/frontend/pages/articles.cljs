(ns app.admin.frontend.pages.articles
  "Admin Articles page.
      ...
      ($ :div {:class "p-6 min-h-screen"}
        ...
        ($ list-view
          {:entity-name entity-name
           ...
           :title "Articles"
           :form-display :modal
           ;; Keep this page read-only for now; article create/edit flows in this repo
           ;; are currently implemented on the user-facing power-user page.
           :allow-add? false
           :allow-edit? false
           :allow-delete? false
