...
(def dicts
  {:bs
   {;; Common actions / labels
    ...
    :profile/default-payer-desc   "Automatski se ažurira na osnovu posljednjeg korištenog platitelja."
   ...
   {;; Common actions / labels
    ...
    :profile/default-payer-desc   "This stays in sync with the last payer you used."
