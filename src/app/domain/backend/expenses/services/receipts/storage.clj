...
(defn upload-receipt!
  ...
  [db {:keys [tenant_id subject_ref created_by_subject_ref payer_id expense_category_id notes storage_key file_hash bytes original_filename content_type file_size] :as data}]
