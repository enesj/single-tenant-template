          ...
          (try
            (let [body (h/read-body-params request)
              ...
              (if (empty? items)
                ...
                (let [{:keys [updated results errors]} (user-expenses/batch-update-user-expenses! db tenant-id user-id parsed-items)]
          ...
          (try
            (let [body (h/read-body-params request)
              ...
              (cond
                ...
                :else
                (let [result (user-expenses/delete-user-expenses! db tenant-id user-id parsed-ids)]
