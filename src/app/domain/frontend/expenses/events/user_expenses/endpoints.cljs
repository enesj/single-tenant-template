...
(def manufacturer-aliases-endpoint (api/versioned-endpoint "/expenses/manufacturer-aliases"))
...
(def admin-manufacturers-endpoint "/admin/api/expenses/manufacturers")
...
(def admin-supplier-aliases-endpoint "/admin/api/expenses/supplier-aliases")
(def admin-manufacturer-aliases-endpoint "/admin/api/expenses/manufacturer-aliases")
