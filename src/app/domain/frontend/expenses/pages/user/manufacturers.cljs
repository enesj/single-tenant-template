(ns app.domain.frontend.expenses.pages.user.manufacturers
  "Power-user manufacturers list (used for selecting manufacturer on articles)."
  (:require
...
(defui manufacturers-page []
  (let [t (use-t)
        ...
        refresh-list (use-callback
                       (fn []
                         (rf/dispatch [:user-expenses/refresh-manufacturers-list]))
                       [])]
    (use-effect
      (fn []
        (rf/dispatch [::list-ui-state-events/set-pagination-mode entity-name :server])
        (rf/dispatch [::list-ui-state-events/set-refresh-event entity-name [:user-expenses/refresh-manufacturers-list]])
        (refresh-list)
        js/undefined)
      [refresh-list])
