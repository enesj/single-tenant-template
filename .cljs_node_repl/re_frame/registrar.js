...
if(re_frame.interop.debug_enabled_QMARK_){
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core.not.call(null,re_frame.settings.loaded_QMARK_.call(null));
...
return re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),"re-frame: can't clear",(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind)),"handler for",(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)+". Handler not found."));
}
}));
