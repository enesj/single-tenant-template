...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__57630 = cljs.core.instance_QMARK_;
var expr__57631 = reactive_val;
if(cljs.core.truth_(pred__57630.call(null,reagent.ratom.RAtom,expr__57631))){
return "ra";
} else {
if(cljs.core.truth_(pred__57630.call(null,reagent.ratom.RCursor,expr__57631))){
return "rc";
} else {
if(cljs.core.truth_(pred__57630.call(null,reagent.ratom.Reaction,expr__57631))){
return "rx";
} else {
if(cljs.core.truth_(pred__57630.call(null,reagent.ratom.Track,expr__57631))){
return "tr";
} else {
return "other";
}
...
})())+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.hash.call(null,reactive_val)));
} else {
return null;
}
});
