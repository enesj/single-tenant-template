...
return cljs.core.some.call(null,(function (p1__60159_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__60159_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__60160){
var map__60161 = p__60160;
var map__60161__$1 = cljs.core.__destructure_map.call(null,map__60161);
var request = map__60161__$1;
var response_format = cljs.core.get.call(null,map__60161__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__60163){
var map__60164 = p__60163;
var map__60164__$1 = cljs.core.__destructure_map.call(null,map__60164);
var request = map__60164__$1;
var response_format = cljs.core.get.call(null,map__60164__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__60162_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__60162_SHARP_);
}),formats);
});
/**
...
return ajax.interceptors.map__GT_ResponseFormat.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),ajax.formats.detect_response_format_read.call(null,opts),new cljs.core.Keyword(null,"format","format",-1306924766),(""+"(from "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(accept)+")"),new cljs.core.Keyword(null,"content-type","content-type",-508222634),accept], null));
});
