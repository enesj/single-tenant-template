...
var G__57477 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__57477,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__57478__delegate = function (args){
...
while (G__57479__i < G__57479__a.length) {G__57479__a[G__57479__i] = arguments[G__57479__i + 0]; ++G__57479__i;}
  args = new cljs.core.IndexedSeq(G__57479__a,0,null);
} 
return G__57478__delegate.call(this,args);};
G__57478.cljs$lang$maxFixedArity = 0;
G__57478.cljs$lang$applyTo = (function (arglist__57480){
var args = cljs.core.seq(arglist__57480);
return G__57478__delegate(args);
});
...
var G__57481 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__57481,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__57482__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__57483__i < G__57483__a.length) {G__57483__a[G__57483__i] = arguments[G__57483__i + 0]; ++G__57483__i;}
  args = new cljs.core.IndexedSeq(G__57483__a,0,null);
} 
return G__57482__delegate.call(this,args);};
G__57482.cljs$lang$maxFixedArity = 0;
G__57482.cljs$lang$applyTo = (function (arglist__57484){
var args = cljs.core.seq(arglist__57484);
return G__57482__delegate(args);
});
...
var G__57485 = props;
var G__57485__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__57485,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__57485);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__57485__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__57486 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__57486,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__57486;
}
})(),id_class);
...
var G__57487 = (cljs.core.count.call(null,argv) - first_child);
switch (G__57487) {
case (0):
...
var vec__57489 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__57489,(0),null);
var id = cljs.core.nth.call(null,vec__57489,(1),null);
var className = cljs.core.nth.call(null,vec__57489,(2),null);
...
var temp__5827__auto___57492 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5827__auto___57492 == null)){
} else {
var key_57493 = temp__5827__auto___57492;
(jsprops.key = key_57493);
}
...
var temp__5827__auto___57494 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5827__auto___57494 == null)){
} else {
var key_57495 = temp__5827__auto___57494;
(jsprops.key = key_57495);
}
...
var temp__5827__auto___57496 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5827__auto___57496 == null)){
} else {
var key_57497 = temp__5827__auto___57496;
(jsprops.key = key_57497);
}
...
var temp__5827__auto___57498 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5827__auto___57498 == null)){
} else {
var key_57499 = temp__5827__auto___57498;
(jsprops.key = key_57499);
}
...
var temp__5827__auto___57500 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5827__auto___57500 == null)){
} else {
var key_57501 = temp__5827__auto___57500;
(jsprops.key = key_57501);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__57502_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__57502_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__57503 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__57503,(0),null);
var derefed = cljs.core.nth.call(null,vec__57503,(1),null);
...
break;
default:
var G__57508 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__57509 = compiler;
v = G__57508;
compiler = G__57509;
continue;
...
var G__57510 = tag;
var G__57510__$1 = (((G__57510 instanceof cljs.core.Keyword))?G__57510.fqn:null);
switch (G__57510__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reify_reagent$impl$template57513 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reify_reagent$impl$template57513 = (function (opts,id,fn_to_element,parse_fn,meta57514){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta57514 = meta57514;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57515,meta57514__$1){
var self__ = this;
var _57515__$1 = this;
return (new reagent.impl.template.t_reify_reagent$impl$template57513(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta57514__$1));
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57515){
var self__ = this;
var _57515__$1 = this;
return self__.meta57514;
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reify_reagent$impl$template57513.cljs$lang$type = true);

(reagent.impl.template.t_reify_reagent$impl$template57513.cljs$lang$ctorStr = "reagent.impl.template/t_reify_reagent$impl$template57513");

(reagent.impl.template.t_reify_reagent$impl$template57513.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write.call(null,writer__5435__auto__,"reagent.impl.template/t_reify_reagent$impl$template57513");
}));

/**
 * Positional factory function for reagent.impl.template/t_reify_reagent$impl$template57513.
 */
reagent.impl.template.__GT_t_reify_reagent$impl$template57513 = (function reagent$impl$template$create_compiler_$___GT_t_reify_reagent$impl$template57513(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta57514){
return (new reagent.impl.template.t_reify_reagent$impl$template57513(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta57514));
});

}

return (new reagent.impl.template.t_reify_reagent$impl$template57513(opts,id,fn_to_element,parse_fn,null));
});
