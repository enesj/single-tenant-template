...
var l = (cljs.core.truth_(truncate)?(0):cljs.core.min.call(null,(10),n));
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__5747__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__5751__auto__,method_table__5747__auto__,prefer_table__5748__auto__,method_cache__5749__auto__,cached_hierarchy__5750__auto__));
})();
}
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1("\"")+cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),cljs.core.min.call(null,n,x.length)))+cljs.core.str.cljs$core$IFn$_invoke$arity$1(suffix));
}));
