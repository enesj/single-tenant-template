...
(defn should-fetch-current-entity?
  [{:keys [entity-type have-entities? server-pagination?]}]
  (and entity-type
    (keyword? entity-type)
    (not have-entities?)
...
(defn use-entity-fetching
  ...
  [entity-type foreign-key-entity have-entities? have-foreign? server-pagination?]
  (use-effect
    (fn []
      (when (should-fetch-current-entity? {:entity-type entity-type
                                           :have-entities? have-entities?
