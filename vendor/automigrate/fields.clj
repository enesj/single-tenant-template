...
;; TODO(human): Add custom field metadata keys that should be ignored by automigrate
;; These keys follow the same pattern as :validation - they are metadata for UI/admin
;; interfaces and should not be validated as database schema options
