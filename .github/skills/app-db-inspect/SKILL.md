---
name: app-db-inspect
description: "Inspect re-frame app-db state safely in ClojureScript when debugging frontend state (auth/session, routing, data loading, UI state). Use when you need quick, safe snapshots of frontend state."
---
