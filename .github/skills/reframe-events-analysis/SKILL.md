...
description: "Trace and summarize re-frame event and subscription activity in dev builds. Use when UI feels slow, state changes unexpectedly, or you need recent event history."
---
