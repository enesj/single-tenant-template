---
name: migrations
description: "Complete migration workflow guide for models, schema, functions, triggers, policies, and views. Use when changing the database schema or running automigrate workflows."
---
