...
If the CLI tools are not available, derive test obligations manually from the spec using the test-generation taxonomy in `../allium/references/test-generation.md`.
