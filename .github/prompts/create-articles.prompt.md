---
description: "Map OCR article aliases using batch local heuristics plus Perplexity research, review, create_articles, map_aliases, and dedicated manufacturers handoff"
agent: "agent"
metadata:
