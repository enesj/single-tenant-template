---
description: "Apply settings changes through the real admin/user settings UI using chrome-devtools — no code modifications"
metadata:
  tags: ["settings", "admin", "user-settings", "chrome-devtools", "ui-automation"]
---
