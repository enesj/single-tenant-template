````skill
---
description: REPL-first Clojure/ClojureScript exploration and evaluation workflow (nREPL + clj-nrepl-eval).
metadata:
	tags: ["repl", "nrepl", "clojure", "cljs", "debugging", "exploration"]
---
