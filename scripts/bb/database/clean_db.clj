    ...
    (let [[env] args]
      (if (#{"dev" "test"} env)
        ...
        (do
          ...
          (println "Usage: clj -M scripts/bb/database/clean_db.clj [dev|test]")
          (System/exit 1))))
    (do
      (println "Usage: clj -M scripts/bb/database/clean_db.clj [dev|test]")
      ...
      (println)
      (println "Examples:")
      (println "  clj -M scripts/bb/database/clean_db.clj dev")
      (println "  clj -M scripts/bb/database/clean_db.clj test")
      (System/exit 1))))
