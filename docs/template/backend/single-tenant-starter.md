...
> **Note:** This document describes the generator’s starter project. For the template you are currently in, see `./single-tenant-template.md`. If you’re not running the generator, treat this as reference.
