...
**Related**:  
- [Admin HTTP guide](../../admin/backend/http-api.md)  
- [Shared frontend HTTP standards](../../shared/frontend/http-standards.md)  
- [Security middleware](../../template/backend/security-middleware.md)
